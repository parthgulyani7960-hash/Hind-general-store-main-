          ...
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-gray-100 p-8 text-center animate-in fade-in zoom-in duration-300">
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full py-3 px-4 bg-gray-900 text-white rounded-xl font-semibold hover:bg-gray-800 transition-colors shadow-lg shadow-gray-200"
              >
                Try Refreshing
              </button>
              ...
              <button 
                ...
                className="w-full py-3 px-4 bg-white text-gray-700 border border-gray-200 rounded-xl font-semibold hover:bg-gray-50 transition-colors"
              >
                Reset & Return Home
              </button>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <p className="text-xs text-gray-400">
                Technical details have been sent to our monitoring service.
              </p>
            </div>
          </div>
        </div>
